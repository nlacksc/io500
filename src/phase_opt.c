...
static ini_option_t option[] = {
  ...
  {"allocateBufferDevice", "Allocate the I/O buffers on 0=CPU, 1=Managed Check CPU, 2=Managed Check GPU, 3=GPU", 0, INI_BOOL, "FALSE", & opt.allocateBufferDevice},
  {"gpuDirect", "Use GPUDirect only useful with Buffers > 0", 0, INI_BOOL, "FALSE", & opt.gpuDirect},
  ...
  {"parallel-runs", "Amount of identical runs to do in parallel", 0, INI_UINT, "1", & opt.parallel_runs},
  {NULL} };
